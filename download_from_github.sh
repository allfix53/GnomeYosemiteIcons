...
wget https://github.com/allfix53/GnomeYosemiteIcons/archive/master.zip
unzip -o master.zip
else
echo Cloning from GitHub repository.
git clone https://github.com/allfix53/GnomeYosemiteIcons.git GnomeYosemiteIcons-master
fi
